...
<head>
  ...
  <title>Love Problem Solver - Admin Login</title>
...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
  ...
  <meta name="description"
    content="love problem solving, reunite soul mates, tele-sensing, tele-programming, intuitive strategic guidance, reunion">
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <nav class="navbar navbar-expand-lg">
    <div class="container-sm">
      <a href="index.html" class="navbar-brand position-relative "><img width="262" height="19" src="assets/images/logo.png"
          class=" first_logo" alt="Love problem solver"><img class="second_logo"
  ...
  <div class="side_nav pc_side_nav">
    <div class="side_nav_wrap">
      ...
      <ul class="side_nav_item align-items-left ms-0 ps-3 pt-5">
        ...
        <li class="nav-item">
          <a class="nav-link p-0 text-uppercase" href="tel:+441135348887">+44 113 534 8887</a>
        </li>
        <li class="nav-item">
    ...
    <div class="container-lg">
      <div class="row">
        <div class="col-lg-8 col-xl-7 col-md-12">
          <h1 class="header text-center text-lg-start "><span class="color-text"></span>Admin Login</h1>
          ...
          <div class="arrow text-center pb-5">
            <a href="#login" class="scrollink"><i class="fa fa-angle-down" aria-hidden="true"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container-xl">
      <div class="row">
        <div class="col-xl-6 mx-auto">
          <h1 class="header color-text mb-5">Login</h1>
          <div class="login_form">
            <div class="row">
              <div class="col-xl-8 mx-auto">
                <form action="<?php echo htmlspecialchars('php/login_validat.php') ?>" method="POST">
                  <div class="input_wrap">
                    <input type="text" placeholder="Username" class="w-100" name="username" value = "<?php
                  ...
                  <div class="submit mt-3">
                    <button type="submit" class="w-100 text-center">Submit</button>
                  </div>
                  </form>
                  <p class="text-center">Want to change Password?<button class="pass_change_btn ms-2" data-bs-toggle="modal" data-bs-target="#pass_change" id="passchangemodal">Click Here</button></p>
              </div>
            </div>
          </div>
        </div>
...
<div class="modal fade" id="pass_change" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="subheader" id="exampleModalLabel">Change Password</h5>
          ...
          <div class="col-xl-6 mx-auto">
            <?php
                ...
                if(isset($_SESSION['success'])) {
                  echo '<div class="password-condition-success text-center">';
                ...
                if(isset($_SESSION['error'])) {
                  echo '<div class="password-condition-error text-center">';
                  echo $_SESSION['error'];
                  echo '</div>';
            ...
            ?>
            <form action="<?php echo htmlspecialchars('php/username_pass_change.php') ?>" method="POST" class="password_form pt-5 pb-5">
              <div class="input_wrap">
                <input type="text" placeholder="Old Username" class="w-100" name="old_username" value="<?php
                
                  if(isset($_SESSION['oldusername'])) {
                    echo $_SESSION['oldusername'];
                  }
              ...
              <?php 
                      ...
                      if(isset($_SESSION['oldusererr'])) {
                        echo '<div class="field_err">';
                        echo $_SESSION['oldusererr'];
                        echo '</div>';
                      }
                      unset($_SESSION['oldusererr']);

              ?>
              <div class="input_wrap mt-3">
                <input type="password" placeholder="Old Password" class="w-100" name="old_pass">
              </div>

              <?php 
              
                      if(isset($_SESSION['oldpasserr'])) {
                        echo '<div class="field_err">';
                        echo $_SESSION['oldpasserr'];
                        echo '</div>';
                      }
              ...
              ?>
              <div class="input_wrap mt-3">
                <input type="text" placeholder="New Username" class="w-100" name="new_username" value="<?php
              ...
              <?php 
                      ...
                      if(isset($_SESSION['newusererr'])) {
                        echo '<div class="field_err">';
                        echo $_SESSION['newusererr'];
                        echo '</div>';
                      }
                      unset($_SESSION['newusererr']);
              ...
              ?>
              <div class="input_wrap mt-3">
                <input type="password" placeholder="Confirm New Password" class="w-100" name="confirm_new_password">
              </div>
              <?php 
              
                      if(isset($_SESSION['confirmpasserr'])) {
                        echo '<div class="field_err">';
    ...
    <div class="container-xl">
      <div class="row">
        <div class="col-xl-6 col-lg-7 col-md-12 ms-auto">
          ...
          <h3 class="subheader">MAKE YOUR LOVE FUTURE THE WAY YOU WANT IT TO BE</h3>
          <div class="divider">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-xl-7 mx-auto">
                ...
                <h4 class="subheader">MAKE YOUR LOVE FUTURE</h4>
                <div class="divider">
                  <img src="assets/images/divider.png" alt="divider" class="w-100 img-fluid">
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="contact_wrap">
                ...
                <p class="d-flex align-items-center"><span class="contact_icon"><i class="fa fa-phone"></i></span><a
                    class="contact_info" href="tel:+441135348887">+44 113 534 8887</a></p>
  ...
  <!-- WiserNotify END -->
  <!--Chat server-->
  <script type="text/javascript">function add_chatinline() { var hccid = 80729712; var nt = document.createElement("script"); nt.async = true; nt.src = "https://www.mylivechat.com/chatinline.aspx?hccid=" + hccid; var ct = document.getElementsByTagName("script")[0]; ct.parentNode.insertBefore(nt, ct); }
