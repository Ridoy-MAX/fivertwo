...
<head>
    ...
    <title>Love Problem Solver - Making your love life how you want it to be</title>
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-sm">
            <a href="index.html" class="navbar-brand position-relative"><img width="262" height="19" src="assets/images/logo.png" class=" first_logo"
                    alt="Love problem solver"><img class="second_logo" src="assets/images/2nd_logo.png" alt="love"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav align-items-center ms-auto">
                  ...
                  <li class="nav-item">
                    <button class="text-uppercase d-flex align-items-center more_side_bar"><span><svg version="1.1" class="hamburger-menu" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" width="16px">
    ...
    ?>
        ...
        <!-- PHP for sending email from form -->

        <?php 
            if(!empty($_POST['email']) && !empty($_POST['phone']) && !empty($_POST['message']) && !empty($_POST['name']) ){
            $to = "loveproblemsolver1@gmail.com"; // this is your Email address
            ...
            if (!$success) {
              $thank_note = "<p class='text-center subheader pb-5 pt-5'>Email is not sent Please contant us Directly</p>";
            }

            else if ($success) {
              $thank_note = "<h2 class='text-center header pt-5 mt-5'>Thank you!</h2>
              <p class='text-center subheader pb-5 mb-5'>We'll be in touch soon.</p>";
              }

            }

            else {
              $thank_note = "<h2 class='text-center header pt-5 mt-5'>Please Fill the form correctly</h2><p class='text-center subheader pb-5 mb-5'>Your privacy is important to us. We promise to keep your email and number safe.</p>";
            }
        ?>
      ...
      <div class="container-xl">
        ...
        <div class="row statement pt-5 pb-4">
          <div class="col-xl-12 mx-auto">
            <p>We are 100% committed to giving you total satisfaction in our professional services and excellent value for money. If there is any aspect of our service with which you are dissatisfied or which you feel could be improved, please let us know - You can send an email or telephone us.</p>
          </div>
        </div>
      </div>
